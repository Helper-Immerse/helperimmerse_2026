        ...
        >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                <div className="sm:col-span-2 lg:col-span-1">
                    <a href="#!">
                        <img className="h-9 w-auto" src="/agentix-react/assets/logo.png" width={138} height={36} alt="logo" />
                    </a>
                    <p className="text-sm/7 mt-6">helperImmerse is a trusted digital solutions platform offering high-quality web, app, and software development services, delivering scalable, customized, and business-focused solutions for clients worldwide.</p>
                </div>
                ...
                <div>
                    <h2 className="font-semibold text-white mb-5">hope you're happy after visited here 😊</h2>
                    <div className="text-sm space-y-6 max-w-sm">
                        <p>If you faced any kind of problem from us, please send a feedback, we will work on it.</p>
            ...
            <p className="py-4 text-center border-t mt-6 border-slate-700">
                {/* Copyright 2025 © <a href="https://prebuiltui.com?utm_source=agentix" target="_blank">PrebuiltUI</a> • Developed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a> • All Right Reserved. */}
            </p>
        </motion.footer>
    );
};