...
const sectionData = [
  {
    title: "Submit Any Type of Development Project",
    description: "We transform your ideas into powerful digital solutions with high-quality development, modern technology, and reliable performance.",
  ...
  {
    title: "Creative Video Editing & Graphic Design Services",
    description: "Enhance your brand identity with visually stunning designs and professional video content that engages your audience.",
    ...
    return (
        <section className="flex flex-col items-center" id="creations">
            <SectionTitle
                ...
                description="A detailed showcase of our professional services — each solution designed with precision, performance, and client success in mind."
            />
