...
export default function AboutOurApps() {
    const sectionData = [
        {
            ...
            description: "Built with speed — minimal load times and optimized. 2 months free support after project delivery",
        ...
        },
        {
            ...
            description: "Modern, pixel-perfect UI components with full security ready for any project.",
        ...
        },
        {
            ...
            description: "Simple setup with supportive user interface.",
    ...
    return (
        <section className="flex flex-col items-center" id="about">
            <SectionTitle title="About Our Services" description="A visual collection of our most recent works - each piece crafted with intention, emotion, and style." />
